                <div class="navbar-header">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        {{-- @include('layouts.backend.partials.header-lang') --}}

                        @include('layouts.backend.partials.header-web')

                        @include('layouts.backend.partials.header-shop')
                        ...
                        @include('layouts.backend.partials.header-notif')

                        @include('layouts.backend.partials.header-user')
                    </div>
                </div>