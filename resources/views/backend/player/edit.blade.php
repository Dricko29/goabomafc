    ...
    <div class="row">
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('siteman.players.update', $player->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    <div class="card-body text-center">
                                        ...
                                        <div class="list-inline mb-0 mt-2">
                                            ...
                                            <button type="submit" class="btn btn-soft-danger" id="deleteFoto"><i class="ri-delete-bin-line align-bottom me-0"></i> Hapus Foto</button>
                                        </div>
                                    </div>
                                    @else
                            ...
                            <div class="col-md-12">
                                <div class="mb-3">
                                    ...
                                    id="position_id">
                                        ...
                                        <option value="{{ $position->id }}"{{ (collect(old('position_id', $player->position_id))->contains($position->id)) ? 'selected':'' }}>{{ $position->nama }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama')
                                        is-invalid
                                    @enderror" name="nama" value="{{ old('nama', $player->nama) }}" placeholder="Masukan nama" id="nama">
                                    @error('nama')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('no_pg')
                                        is-invalid
                                    @enderror" name="no_pg" value="{{ old('no_pg', $player->no_pg) }}" placeholder="Masukan no punggung" id="no_pg">
                                    @error('no_pg')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('no_tlp')
                                        is-invalid
                                    @enderror" name="no_tlp" value="{{ old('no_tlp', $player->no_tlp) }}" placeholder="Masukan no telpon" id="no_tlp">
                                    @error('no_tlp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    value="{{ old('tgl_lahir', $player->tgl_lahir) }}" 
...
@push('js')
    ...
    <script>
        ...
        $(document).on('click', '#deleteFoto', function(e){
            ...
            $.ajax({
                url: `{{ route('siteman.player.delete.foto', $player->id ) }}`,
                method:'DELETE',
