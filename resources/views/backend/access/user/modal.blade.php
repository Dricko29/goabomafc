                        ...
                        <div class="modal-body p-4">
                            ...
                            <div class="mx-n4 px-4" data-simplebar style="max-height: 225px;">
                                <div id="addMember" class="vstack gap-3">
                                    ...
                                    <form action="{{ route('akses.roles.assign.users',[$role->id, $item->id]) }}" method="POST">
                                        @csrf
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-shrink-0">
                                                <button type="submit" data-id="{{ $item->id }}" class="btn btn-danger btn-sm action">Add</button>
                                            </div>
                                        </div>
                                        <!-- end member item -->
                                    </form>
