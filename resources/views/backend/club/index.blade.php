...
<div class="container-fluid">
    <div class="profile-foreground position-relative mx-n4 mt-n4">
        <div class="profile-wid-bg">
            <img src="{{ $club->background }}" alt="" class="profile-wid-img" />
        </div>
    </div>
    <div class="pt-4 mb-4 mb-lg-3 pb-lg-4">
        <div class="row g-4">
            <div class="col-auto">
                <div class="avatar-lg">
                    <img src="{{ $club->logo }}" alt="{{ $club->slug }}-logo" class="img-thumbnail rounded-circle" />
                </div>
            </div>
            <!--end col-->
            <div class="col">
                <div class="p-2">
                    <h3 class="text-white mb-1">{{ Str::upper($club->nama) }}</h3>
                    <p class="text-white-75">{{ Str::lower($club->slug) }}</p>
                    <div class="hstack text-white-50 gap-1">
                        <div class="me-2"><i class="ri-map-pin-user-line me-1 text-white-75 fs-16 align-middle"></i>{{ $club->alamat }}</div>
                        <div>
                            <i class="ri-building-line me-1 text-white-75 fs-16 align-middle"></i>Goa Boma
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div>
                <div class="d-flex">
                    ...
                    <div class="flex-shrink-0">
                        <a href="{{ route('siteman.clubs.edit', $club->id) }}" class="btn btn-success"><i class="ri-edit-box-line align-bottom"></i> Edit Profile</a>
                    </div>
                </div>
                <!-- Tab panes -->
                    ...
                    <div class="tab-pane active" id="overview-tab" role="tabpanel">
                        <div class="row">
                            <div class="col-xxl-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-borderless mb-0">
                                                <tbody>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Nama Club :</th>
                                                        <td class="text-muted">{{ $club->nama }}</td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">No Tlp :</th>
                                                        <td class="text-muted">{{ $club->no_tlp }}</td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-muted">{{ $club->alamat }}
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <th class="ps-0" scope="row">Tahun Terbentuk</th>
                                                        <td class="text-muted">{{ $club->tahun_terbentuk }}</td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title mb-4">Social Mediaa</h5>
                                        <div class="d-flex flex-wrap gap-2">
                                            <div>
                                                <a href="https://id-id.facebook.com/" class="avatar-xs d-block">
                                            ...
                                            <div>
                                                <a href="https://www.instagram.com/?hl=id" class="avatar-xs d-block">
                            ...
                            <div class="col-xxl-9">
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title mb-3">Sejarah Club</h5>
                                        <p>{!! $club->sejarah !!}</p>
